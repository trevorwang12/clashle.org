...
import type { SeoData } from '@/lib/seo-service'

interface HomePageClientProps {
  initialSeoData: SeoData
}

export default function HomePageClient({ initialSeoData }: HomePageClientProps) {
  ...
  const [seoData, setSeoData] = useState<SeoData | null>(initialSeoData)
  ...
  return (
    <div className="min-h-screen bg-white">
      {/* Header */}
      <Header initialSeoSettings={initialSeoData.seoSettings} />
      ...
      <div className="max-w-7xl mx-auto px-4 py-6">
        ...
        <PageH1 
          pageType="homepage" 
          data={{ siteName: seoData?.seoSettings?.siteName || initialSeoData.seoSettings.siteName }} 
      ...
      {/* Footer */}
      <Footer initialSeoSettings={initialSeoData.seoSettings} />
    </div>
  )
}
